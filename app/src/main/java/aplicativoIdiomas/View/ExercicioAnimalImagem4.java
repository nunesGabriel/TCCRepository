...
public class ExercicioAnimalImagem4 extends Activity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.exercicioimagemanimal4);
    ...
    public void retornaMain(View view){
        Intent intent = new Intent(ExercicioAnimalImagem4.this, MainActivity.class);
        ...
        if(erros >= ControleExercicios.qtdErros) {
            ...
            declineButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    selecaoExercicio.handleSelecaoExercicioAnimais(ExercicioAnimalImagem4.this);
                }
            });
        }
    }
