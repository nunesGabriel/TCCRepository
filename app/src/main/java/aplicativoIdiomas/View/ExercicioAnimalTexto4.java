...
public class ExercicioAnimalTexto4 extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.exerciciotextoanimal4);
    ...
    public void retornaMain(View view) {
        Intent intent = new Intent(ExercicioAnimalTexto4.this, MainActivity.class);
        ...
        if (erros >= ControleExercicios.qtdErros) {
            ...
            declineButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    selecaoExercicio.handleSelecaoExercicioAnimais(ExercicioAnimalTexto4.this);
                }
            });
        }
    }
    ...
    public void respostaCerta(View view) {
        ...
        mp = MediaPlayer.create(this, R.raw.elephant); //Localizando o arquivo
        mp.start();
