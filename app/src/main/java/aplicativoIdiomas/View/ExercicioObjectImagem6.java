...
public class ExercicioObjectImagem6 extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.exercicioimagemobject6);
    ...
    public void retornaMain(View view) {
        Intent intent = new Intent(ExercicioObjectImagem6.this, MainActivity.class);
        ...
        if (erros >= ControleExercicios.qtdErros) {
            ...
            declineButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    selecaoExercicio.handleSelecaoExercicioAnimais(ExercicioObjectImagem6.this);
                }
            });
        }
    }
    ...
    public void respostaCerta(View view) {
        ...
        mp = MediaPlayer.create(this, R.raw.pencil); //Localizando o arquivo
        mp.start();
        ...
        declineButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //Seleciona o próximo exercício aleatoriamente
                selecaoExercicio.handleSelecaoExercicioObjetos(ExercicioObjectImagem6.this);
            }
        });
    }
}
