...
public class ExercicioAnimalTexto7 extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.exerciciotextoanimal7);
    ...
    public void retornaMain(View view) {
        Intent intent = new Intent(ExercicioAnimalTexto7.this, MainActivity.class);
        ...
        if (erros >= ControleExercicios.qtdErros) {
            ...
            declineButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    selecaoExercicio.handleSelecaoExercicioAnimais(ExercicioAnimalTexto7.this);
                }
            });
        }
    }
