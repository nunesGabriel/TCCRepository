...
public class ExercicioObjectTexto6 extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.exercicioobjecttexto6);
    ...
    public void retornaMain(View view) {
        Intent intent = new Intent(ExercicioObjectTexto6.this, MainActivity.class);
        ...
        if (erros >= ControleExercicios.qtdErros) {
            ...
            declineButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    selecaoExercicio.handleSelecaoExercicioAnimais(ExercicioObjectTexto6.this);
                }
            });
        }
    }
