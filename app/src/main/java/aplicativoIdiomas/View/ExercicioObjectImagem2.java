...
public class ExercicioObjectImagem2 extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.exercicioimagemobject2);
    ...
    public void retornaMain(View view) {
        Intent intent = new Intent(ExercicioObjectImagem2.this, MainActivity.class);
        ...
        if (erros >= ControleExercicios.qtdErros) {
            ...
            declineButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    selecaoExercicio.handleSelecaoExercicioAnimais(ExercicioObjectImagem2.this);
                }
            });
        }
    }
    ...
    public void respostaCerta(View view) {
        ...
        mp = MediaPlayer.create(this, R.raw.computer); //Localizando o arquivo
        mp.start();
        ...
        declineButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //Seleciona o próximo exercício aleatoriamente
                selecaoExercicio.handleSelecaoExercicioObjetos(ExercicioObjectImagem2.this);
            }
        });
