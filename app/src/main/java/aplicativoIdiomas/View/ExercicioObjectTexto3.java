...
public class ExercicioObjectTexto3 extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.exercicioobjecttexto3);
    ...
    public void retornaMain(View view) {
        Intent intent = new Intent(ExercicioObjectTexto3.this, MainActivity.class);
        ...
        if (erros >= ControleExercicios.qtdErros) {
            ...
            declineButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    selecaoExercicio.handleSelecaoExercicioAnimais(ExercicioObjectTexto3.this);
                }
            });
        }
    }
    ...
    public void respostaCerta(View view) {
        ...
        mp = MediaPlayer.create(this, R.raw.scissor); //Localizando o arquivo
        mp.start();
