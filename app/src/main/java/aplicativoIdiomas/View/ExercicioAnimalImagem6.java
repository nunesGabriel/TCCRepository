...
public class ExercicioAnimalImagem6 extends Activity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.exercicioimagemanimal6);
    ...
    public void retornaMain(View view){
        Intent intent = new Intent(ExercicioAnimalImagem6.this, MainActivity.class);
        ...
        if(erros >= ControleExercicios.qtdErros) {
            ...
            declineButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    selecaoExercicio.handleSelecaoExercicioAnimais(ExercicioAnimalImagem6.this);
                }
            });
        }
    }
    ...
    public void respostaCerta(View view){
        ...
        mp = MediaPlayer.create(this, R.raw.wolf); //Localizando o arquivo
        mp.start();
