...
public class ExercicioObjectTexto4 extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.exercicioobjecttexto4);
        ...
        resposta = (ImageButton) findViewById(R.id.btnimg3);
    ...
    public void retornaMain(View view) {
        Intent intent = new Intent(ExercicioObjectTexto4.this, MainActivity.class);
        ...
        if (erros >= ControleExercicios.qtdErros) {
            ...
            declineButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    selecaoExercicio.handleSelecaoExercicioAnimais(ExercicioObjectTexto4.this);
                }
            });
        }
    }
    ...
    public void respostaCerta(View view) {
        ...
        mp = MediaPlayer.create(this, R.raw.pencil_sharpener); //Localizando o arquivo
        mp.start();
