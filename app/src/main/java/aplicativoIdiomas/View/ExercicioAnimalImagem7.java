...
public class ExercicioAnimalImagem7 extends Activity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.exercicioimagemanimal7);
    ...
    public void retornaMain(View view){
        Intent intent = new Intent(ExercicioAnimalImagem7.this, MainActivity.class);
    ...
    public void onClick(View view) {
        if(erros < ControleExercicios.qtdErros) {
            ...
            if (view.getId() == R.id.btnalternativa7) {
                ...
                resposta = (Button) findViewById(R.id.btnalternativa7);
                ...
                declineButton.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        selecaoExercicio.handleSelecaoExercicioAnimais(ExercicioAnimalImagem7.this);
                    }
                });
