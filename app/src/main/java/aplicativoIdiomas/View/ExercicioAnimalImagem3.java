...
public class ExercicioAnimalImagem3 extends Activity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.exercicioimagemanimal3);
    ...
    public void retornaMain(View view){
        Intent intent = new Intent(ExercicioAnimalImagem3.this, MainActivity.class);
    ...
    public void respostaCerta(View view){
        ...
        mp = MediaPlayer.create(this, R.raw.tiger); //Localizando o arquivo
        mp.start();
