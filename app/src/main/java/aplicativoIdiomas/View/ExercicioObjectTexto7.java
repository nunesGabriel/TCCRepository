...
public class ExercicioObjectTexto7 extends Activity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.exercicioobjecttexto7);
    ...
    public void retornaMain(View view){
        Intent intent = new Intent(ExercicioObjectTexto7.this, MainActivity.class);
        ...
        if(erros >= ControleExercicios.qtdErros) {
            ...
            declineButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    selecaoExercicio.handleSelecaoExercicioAnimais(ExercicioObjectTexto7.this);
                }
            });
        }
    }
